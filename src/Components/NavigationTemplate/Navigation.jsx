import Nav from "../NavigationTemplate/NaviconTemplate/Nav.jsx"
    ...
    return (<div className= {`navigation ${nav && "active"}`}>
        ...
        <header>
            <div className="profile">
                <img
                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSOvQChTclwTv18S4S9VJNoASGg8Ak8dqhHmQ&usqp=CAU"
                    alt ="user-img"
...
<div className="divider"></div>
  ...
  <svg
    ...
    style={{ fill: '#f10505', width: '125%', height: 75, transform: 'rotate(180deg)' }}
  >
    <path
